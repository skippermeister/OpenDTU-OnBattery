...
#ifdef USE_RADIO_CMT
void HoymilesClass::initCMT(const int8_t pin_sdio, const int8_t pin_clk, const int8_t pin_cs, const int8_t pin_fcs,
                            const int8_t pin_gpio2, const int8_t pin_gpio3,
                            const int8_t chip_int1gpio, const int8_t chip_int2gpio)
{
    _radioCmt->init(pin_sdio, pin_clk, pin_cs, pin_fcs,
                    pin_gpio2, pin_gpio3,
                    chip_int1gpio, chip_int2gpio);
}
#endif
