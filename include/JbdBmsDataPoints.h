...
#define JBD_PROTECTION_STATUS(fnc) \
    ...
    fnc(overTemperatureCharge, (1<<4)) \
    fnc(underTemperatureCharge, (1<<5)) \
    fnc(overTemperatureDischarge, (1<<6)) \
    fnc(underTemperatureDischarge, (1<<7)) \
    fnc(overCurrentCharge, (1<<8)) \
    fnc(overCurrentDischarge, (1<<9)) \
