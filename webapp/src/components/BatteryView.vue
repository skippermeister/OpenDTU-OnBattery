    ...
    <template v-else>
        <div class="row gy-3 mt-0">
            <div class="col-sm-3 col-md-2" :style="[packData.length == 1 ? { display: 'none' } : {}]">
                ...
                >
                    <button
                        v-for="pack in packData"
                        :key="pack.moduleNumber"
                        class="nav-link border border-primary text-break"
                        :id="'v-pills-' + pack.moduleNumber + '-tab'"
                        data-bs-toggle="pill"
                        :data-bs-target="'#v-pills-' + pack.moduleNumber"
                        type="button"
                        role="tab"
                        aria-controls="'v-pills-' + pack.moduleNumber"
                        aria-selected="true"
                    >
                        <div class="row">
            ...
            >
                <div
                    ...
                    :id="'v-pills-' + pack.moduleNumber"
                    role="tabpanel"
                    :aria-labelledby="'v-pills-' + pack.moduleNumber + '-tab'"
                    tabindex="0"
                >
                    <div class="card">
                        <div
                            ...
                            <div class="p-1 flex-grow-1">
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        v-if="'numberOfPacks' in batteryData && batteryData.numberOfPacks <= 1"
                                    >
                        ...
                        <div class="card-body">
                            <div class="row flex-row flex-wrap align-items-start g-3">
                                ...
                                <div class="col order-1" v-if="batteryData.issues != null">
                                    <div class="card card-table" style="overflow: hidden">
                                        ...
                                        <div class="card-body">
                                            <div class="row flex-row flex-wrap align-items-start g-3">
                                                <div
                                                    class="col order-0"
                                                    v-if="
                                                        'numberOfPacks' in batteryData && batteryData.numberOfPacks > 1
                                                    "
                                                >
                                                    <div
                                                        class="card card-table"
                                                    ...
                                                    >
                                                        <div class="card-header bg-info">
                                                            {{ pack.moduleRole }} {{ pack.moduleName }} (S/N:
                                                            {{ pack.moduleSerialNumber }}) Software Version:
                                                            {{ pack.swversion }}
                                                        </div>
                                                        <div class="table-responsive">
                                                            <table
                                                        ...
                                                        <template v-if="pack.parameters != null">
                                                            ...
                                                            <div class="table-responsive">
                                                                ...
                                                                >
                                                                    <tbody>
                                                                        <tr
                                                                            v-for="(prop, key) in pack.parameters"
                                                                            v-bind:key="key"
                                                                        >
                                                                            <th scope="row">
                                                                                {{ $t('battery.' + key) }}
    ...
    updated() {
        ...
        if (this.isFirstFetchAfterConnect) {
            ...
            this.$nextTick(() => {
                ...
                const firstTabEl = document.querySelector('#v-pills-tab-pack:first-child button');
                if (firstTabEl != null) {
        ...
        initSocket() {
            ...
            this.socket.onmessage = (event) => {
                ...
                if (event.data != '{}') {
                    ...
                    const foundIdx = this.batteryData.packs.findIndex(
                        (element) => element.moduleNumber == newData.packs[0].moduleNumber
                    );
                    if (foundIdx == -1) {
