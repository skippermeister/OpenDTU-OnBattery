        ...
        <div class="table-responsive">
            <table class="table table-hover table-condensed">
                <tbody>
                    ...
                    <tr v-for="task in taskDetails.tasks" v-bind:key="task.name">
...
import type { Tasks } from '@/types/SystemStatus';
...
export default defineComponent({
    ...
    props: {
        taskDetails: { type: Object as PropType<Tasks>, required: true },
    },
    methods: {
