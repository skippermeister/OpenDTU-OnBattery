    ...
    <div class="row mb-3">
        ...
        <div :class="[wide2_1 || wide3_1 || wide4_1 || wide5_1 ? 'col-sm-1'
            ...
            <div v-if="!isTextarea" :class="{ 'form-check form-switch': isCheckbox, 'input-group': postfix || prefix }">
                ...
                <input v-model="model" :class="[isCheckbox ? 'form-check-input' : 'form-control']" :id="inputId"
                    :placeholder="placeholder" :type="type" :maxlength="maxlength" :min="min" :max="max" :step="step"
            ...
            <div v-else>
                <textarea v-model="model" class="form-control" :id="inputId" :maxlength="maxlength" :rows="rows"
