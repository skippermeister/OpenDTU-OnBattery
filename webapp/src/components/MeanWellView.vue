                        ...
                        <div class="p-1 flex-grow-1">
                            <div class="d-flex flex-wrap">
                                <div style="padding-right: 2em">
                                    {{ $t('meanwell.ACcharger') }}: {{ meanwellData.manufacturerModelName }}
                                </div>
                                <div style="padding-right: 2em">
                                    <template v-if="meanwellData.automatic">{{
                                        $t('meanwell.AutomaticCharging')
                                    }}</template>
                        ...
                        <div class="btn-toolbar p-2" role="toolbar">
                            <div class="btn-group me-2" role="group">
                                <button
                                    ...
                                    @click="onShowMeanwellLimitSettings()"
                                    v-tooltip
                            ...
                            <div class="btn-group me-2" role="group">
                                <button
                                    ...
                                    type="button"
                                    class="btn btn-sm btn-danger"
                                    @click="onShowMeanwellPowerSettings()"
                                    v-tooltip
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right; padding-right: 0">
                                                        ...
                                                        >
                                                            <template v-if="meanwellData.operation">{{
                                                                $t('meanwell.on')
                                                            }}</template>
                                                    ...
                                                    <td style="text-align: right; padding-right: 0">
                                                        ...
                                                        >
                                                            <template v-if="meanwellData.cuve">{{
                                                                $t('meanwell.charger_mode')
                                                            }}</template>
                                                            <template v-else>{{
                                                                $t('meanwell.power_supply_mode')
                                                            }}</template>
                                                        </span>
                                                    </td>
                                                    <td></td>
                                                    ...
                                                    <td style="text-align: right; padding-right: 0">
                                                        ...
                                                        >
                                                            <template v-if="meanwellData.stgs">{{
                                                                $t('meanwell.two_stage_charge')
                                                            }}</template>
                                                            <template v-else>{{
                                                                $t('meanwell.three_stage_charge')
                                                            }}</template>
                                                        </span>
                                                    </td>
                                                    <td></td>
                        ...
                        <div class="modal-body">
                            ...
                            <template v-if="!meanwellLimitSettingLoading">
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <input
                                            id="inputCurve_CVLimit"
                                            name="inputCurve_CVLimit"
                                            class="form-control"
                                            type="number"
                                            step="0.01"
                                            precision="2"
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <input
                                            id="inputCurve_CCLimit"
                                            name="inputCurve_CCLimit"
                                            class="form-control"
                                            type="number"
                                            step="0.01"
                                            precision="2"
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <input
                                            id="inputCurve_TCLimit"
                                            name="inputCurve_TCLimit"
                                            class="form-control"
                                            type="number"
                                            step="0.01"
                                            precision="2"
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-9">
                                        <div
                                            v-if="targetLimitList.voltage < targetVoltageLimitMin"
                                            class="alert alert-secondary mt-3"
                                            role="alert"
                                            v-html="$t('meanwell.LimitHint')"
                                        ></div>
                                    </div>
                                </div>
                            </template>
                        ...
                        <template v-if="!meanwellPowerSettingLoading">
                            ...
                            <div class="d-grid gap-2 col-6 mx-auto">
                                ...
                                <button type="button" class="btn btn-warning" @click="onSetMeanwellPowerSettings(2)">
                                    <BIconArrowCounterclockwise class="fs-4" />&nbsp;{{
                                        $t('meanwell.AutomaticCharging')
                                    }}
                                </button>
                            </div>
...
export default defineComponent({
    ...
    methods: {
        ...
        initSocket() {
            ...
            const webSocketUrl = `${protocol === 'https:' ? 'wss' : 'ws'}://${authString}${host}/meanwelllivedata`;
