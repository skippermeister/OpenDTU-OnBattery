        ...
        <form @submit="saveBatteryConfig">
            <CardElement :text="$t('batteryadmin.BatteryConfiguration')" textVariant="text-bg-primary">
                ...
                <div v-show="batteryConfigList.enabled">
                    <InputElement
                        :label="$t('batteryadmin.UpdatesOnly')"
                    ...
                    <InputElement
                        v-show="batteryConfigList.provider < 3"
            ...
            <div v-show="batteryConfigList.enabled">
                <CardElement :text="$t('batteryadmin.BatteryParameter')" textVariant="text-bg-primary" add-space>
                    ...
                    <InputElement
                        :label="$t('batteryadmin.MinChargeTemp')"
                    ...
                    <InputElement
                        :label="$t('batteryadmin.MaxChargeTemp')"
                    ...
                    <InputElement
                        :label="$t('batteryadmin.MinDischargeTemp')"
                    ...
                    <InputElement
                        :label="$t('batteryadmin.MaxDischargeTemp')"
                    ...
                    <InputElement
                        v-if="batteryConfigList.provider != 10"
                ...
                <template
                    v-if="
                        batteryConfigList.mqtt != null && batteryConfigList.enabled && batteryConfigList.provider == 9
                    "
                >
                ...
                <template v-if="batteryConfigList.enabled">
                    ...
                    >
                        ...
                        <template
                            v-if="
                                batteryConfigList.enableDischargeCurrentLimit &&
                                batteryConfigList.useBatteryReportedDischargeCurrentLimit
                            "
                        >
                            <div
                ...
                <template
                    v-if="
                        ...
                        batteryConfigList.zendure != null &&
                        batteryConfigList.provider == 10
                    "
                >
...
export default defineComponent({
    ...
    methods: {
        getIoProvider() {
            if (
                (this.batteryConfigList.provider == 1 && this.batteryConfigList.io_providername != 'RS485') ||
                ((this.batteryConfigList.provider == 2 || this.batteryConfigList.provider == 3) &&
                    (this.batteryConfigList.io_providername == 'RS232' ||
                        this.batteryConfigList.io_providername == 'RS485')) ||
                (this.batteryConfigList.provider > 3 &&
                    this.batteryConfigList.provider < 7 &&
                    this.batteryConfigList.io_providername != 'RS232' &&
                    this.batteryConfigList.io_providername != 'RS485') ||
                ...
                this.alertMessage =
                    'I/O interface ' +
                    this.batteryConfigList.io_providername +
                    ' is not supported for this battery provider. Please configure correct interface in pinmapping.json file';
