    ...
    <BasePage :title="$t('networkadmin.NetworkSettings')" :isLoading="dataLoading">
        ...
        <form @submit="saveNetworkConfig">
            <CardElement :text="$t('networkadmin.WifiConfiguration')" textVariant="text-bg-primary">
                <InputElement :label="$t('networkadmin.WifiSsid')" v-model="networkConfigList.ssid" type="text"
                    maxlength="32" wide2_4 />

                <InputElement :label="$t('networkadmin.WifiPassword')" v-model="networkConfigList.password"
                    type="password" maxlength="64" wide2_4 />

                <InputElement :label="$t('networkadmin.Hostname')" v-model="networkConfigList.hostname" type="text"
                    maxlength="32" wide2_4 />
            ...
            <CardElement :text="$t('networkadmin.StaticIpConfiguration')" textVariant="text-bg-primary" add-space
                ...
                <InputElement :label="$t('networkadmin.IpAddress')" v-model="networkConfigList.ipaddress" type="text"
                    maxlength="32" wide2_4 />

                <InputElement :label="$t('networkadmin.Netmask')" v-model="networkConfigList.netmask" type="text"
                    maxlength="32" wide2_4 />

                <InputElement :label="$t('networkadmin.DefaultGateway')" v-model="networkConfigList.gateway" type="text"
                    maxlength="32" wide2_4 />

                <InputElement :label="$t('networkadmin.Dns', { num: 1 })" v-model="networkConfigList.dns1" type="text"
                    maxlength="32" wide2_4 />

                <InputElement :label="$t('networkadmin.Dns', { num: 2 })" v-model="networkConfigList.dns2" type="text"
                    maxlength="32" wide2_4 />
            </CardElement>

            <CardElement :text="$t('networkadmin.MdnsSettings')" textVariant="text-bg-primary" add-space>
                <InputElement :label="$t('networkadmin.EnableMdns')" v-model="networkConfigList.mdnsenabled"
                    type="checkbox" />
            </CardElement>
            ...
            <CardElement :text="$t('networkadmin.ModbusSettings')" textVariant="text-bg-primary" add-space>
                <InputElement :label="$t('networkadmin.EnableFroniusSM')"
                    v-model="networkConfigList.froniussmmodbusenabled" type="checkbox" />
            </CardElement>

            <CardElement :text="$t('networkadmin.AdminAp')" textVariant="text-bg-primary" add-space>
                <InputElement :label="$t('networkadmin.ApTimeout')" v-model="networkConfigList.aptimeout" type="number"
                    min="0" max="99999" wide3_1 :tooltip="$t('networkadmin.ApTimeoutHint')" />
            </CardElement>
