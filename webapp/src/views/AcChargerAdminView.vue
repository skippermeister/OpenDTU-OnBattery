        ...
        <form @submit="saveChargerConfig">
            <CardElement :text="$t('acchargeradmin.ChargerConfiguration')" textVariant="text-bg-primary">
                ...
                <div v-show="acChargerConfigList.enabled">
                    <InputElement
                        :label="$t('acchargeradmin.UpdatesOnly')"
            ...
            <div v-show="acChargerConfigList.enabled">
                <CardElement
                    ...
                    :text="$t('acchargeradmin.CanControllerConfiguration')"
                ...
                >
                    ...
                    <InputElement
                        :label="$t('acchargeradmin.mustInverterProduce')"
                    ...
                    <InputElement
                        :label="$t('acchargeradmin.PollInterval')"
                    ...
                    <InputElement
                        :label="$t('acchargeradmin.Min_Voltage')"
                    ...
                    <InputElement
                        :label="$t('acchargeradmin.Max_Voltage')"
                    ...
                    <InputElement
                        :label="$t('acchargeradmin.Min_Current')"
                    ...
                    <InputElement
                        :label="$t('acchargeradmin.Max_Current')"
                    ...
                    <InputElement
                        :label="$t('acchargeradmin.Hysteresis')"
                ...
                <div v-if="acChargerConfigList.huawei != null">
                    <CardElement
                        v-show="
                            acChargerConfigList.huawei.auto_power_enabled ||
